<x-app-layout>
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white shadow-sm sm:rounded-lg">
            <div class="p-6">
                <form method="POST" action="{{ route('contact-types.store') }}" class="space-y-6" x-data="{ iconClass: '{{ old('icon_class', 'bi bi-telephone') }}' }">
                    @csrf
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">The name of the contact platform (e.g., WhatsApp, Instagram)</p>
                    </div>
