                ...
                <div class="flex-1" 
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all">
