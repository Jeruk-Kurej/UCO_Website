        ...
        <div class="bg-gradient-to-br from-slate-50 to-blue-50 border border-slate-200 rounded-xl shadow-sm px-4 sm:px-8 py-6 sm:py-10 mb-6 sm:mb-8">
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <h1 class="text-2xl sm:text-3xl font-bold text-slate-800 truncate">Tambah Business Baru</h1>
                    <p class="text-xs sm:text-base text-slate-600 mt-1 sm:mt-2">Lengkapi informasi business Anda</p>
                </div>
            </div>
        </div>

        {{-- ======================================== FORM ======================================== --}}
        <form method="POST" action="/businesses" enctype="multipart/form-data" class="space-y-4 sm:space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
                ...
                <div class="p-4 sm:p-6 space-y-4 sm:space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                        <div>
                            <label for="city" class="block text-xs sm:text-sm font-medium text-slate-700 mb-2">
                        ...
                        <div>
                            <label for="province" class="block text-xs sm:text-sm font-medium text-slate-700 mb-2">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                ...
                <a href="/businesses" class="flex-1 bg-gradient-to-r from-slate-400 to-slate-500 hover:from-slate-500 hover:to-slate-600 text-white font-semibold py-3 sm:py-4 px-6 rounded-lg shadow-md transition text-center text-sm sm:text-base">
                    ✖ Batal
                </a>
            </div>
        </form>
