<x-app-layout>
    <div class="space-y-12">
        ...
        @if($featuredBusinesses->count() > 0)
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex items-end justify-between border-b border-soft-gray-200 pb-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button onclick="prevSlide()" class="group bg-white hover:bg-uco-orange-600 text-soft-gray-700 hover:text-white p-2.5 rounded-lg border border-soft-gray-200 hover:border-uco-orange-600 shadow-sm hover:shadow-md transition-all duration-300">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 19l-7-7 7-7"/>
                                </svg>
                            </button>
                            <button onclick="nextSlide()" class="group bg-white hover:bg-uco-orange-600 text-soft-gray-700 hover:text-white p-2.5 rounded-lg border border-soft-gray-200 hover:border-uco-orange-600 shadow-sm hover:shadow-md transition-all duration-300">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative overflow-hidden">
                        <div id="carousel" class="flex transition-transform duration-500 ease-in-out">
                            @foreach($featuredBusinesses->chunk(2) as $chunkIndex => $businessChunk)
                                <div class="w-full flex-shrink-0">
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        @foreach($businessChunk as $business)
                                            <a href="{{ route('businesses.show', $business) }}" 
                                               class="group bg-white border border-soft-gray-200 rounded-xl overflow-hidden hover:shadow-xl hover:border-soft-gray-300 transition-all duration-300">
                                                ...
                                                @else
                                                    <div class="h-72 bg-gradient-to-br from-soft-gray-50 to-soft-gray-100 flex items-center justify-center">
                                                ...
                                                <div class="p-6">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <h3 class="text-xl font-bold text-soft-gray-900 group-hover:text-uco-orange-600 transition-colors leading-tight">
                                                            {{ $business->name }}
                                                        </h3>
                                                    </div>
                    ...
                    <div class="flex justify-center gap-2 mt-6">
                        @foreach($featuredBusinesses->chunk(2) as $index => $chunk)
                            <button onclick="goToSlide({{ $index }})" class="carousel-dot w-2.5 h-2.5 rounded-full bg-soft-gray-300 hover:bg-uco-orange-400 transition-all duration-300 {{ $index === 0 ? 'bg-uco-orange-600 w-8' : '' }}"></button>
                        @endforeach
                    </div>
                </div>
            </div>
            ...
            <script>
                let currentSlide = 0;
                const totalSlides = {{ $featuredBusinesses->chunk(2)->count() }};
                ...
                function updateCarousel() {
                    ...
                    dots.forEach((dot, index) => {
                        if (index === currentSlide) {
                            dot.classList.remove('bg-soft-gray-300', 'w-2.5');
                            dot.classList.add('bg-uco-orange-600', 'w-8');
                        } else {
                            dot.classList.remove('bg-uco-orange-600', 'w-8');
                            dot.classList.add('bg-soft-gray-300', 'w-2.5');
                        }
                    });
                }
