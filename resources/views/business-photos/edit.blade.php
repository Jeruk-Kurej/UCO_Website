<x-app-layout>
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6 flex items-center gap-3">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Business Photo</h1>
                ...
                <form method="POST" 
                    ...
                    <div>
                        ...
                        <textarea name="caption" 
                                  ...
                                  placeholder="Add a description for this photo...">{{ old('caption', $photo->caption) }}</textarea>
                        @error('caption')
    ...
    Cancel
                ...
                <form id="delete-form" action="{{ route('businesses.photos.destroy', [$business, $photo]) }}" method="POST" class="hidden">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
    ...
    @push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => ucoInitImagePreview('photo', 'bp-edit', 10, false));
    </script>
    @endpush
</x-app-layout>