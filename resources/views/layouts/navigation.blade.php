<nav class="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
                ...
                @auth
                    ...
                    @if(auth()->user()->isAdmin())
                        ...
                        <div class="relative group">
                            ...
                            <div class="absolute right-0 mt-2 w-52 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                                <div class="py-1">
                                    <a href="{{ route('users.index') }}" class="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-purple-600">
                                        Manage Users
                                    </a>
                                    <a href="{{ route('business-types.index') }}" class="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-purple-600">
                                        Business Types
                                    </a>
                                    <a href="{{ route('contact-types.index') }}" class="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-purple-600">
                                        Contact Types
                                    </a>
                                    <a href="{{ route('ai-analyses.index') }}" class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-purple-600">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                            ...
                            <div class="py-1">
                                <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-purple-600">
                                    My Profile
                                </a>
    ...
    <div x-data="{ open: false }" :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden border-t border-gray-200 bg-white">
        <div class="px-4 py-3 space-y-1">
            ...
            @auth
                ...
                @if(auth()->user()->isAdmin())
                    <div class="pt-2 border-t border-gray-200">
                        ...
                        <a href="{{ route('users.index') }}" class="block py-2 text-sm font-medium text-gray-700 hover:text-purple-600">
                            Manage Users
                        </a>
                        <a href="{{ route('business-types.index') }}" class="block py-2 text-sm font-medium text-gray-700 hover:text-purple-600">
                            Business Types
                        </a>
                        <a href="{{ route('contact-types.index') }}" class="block py-2 text-sm font-medium text-gray-700 hover:text-purple-600">
                            Contact Types
                        </a>
                        <a href="{{ route('ai-analyses.index') }}" class="flex items-center gap-2 py-2 text-sm font-medium text-gray-700 hover:text-purple-600">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                            AI Moderation
                ...
                <div class="pt-2 border-t border-gray-200">
                    ...
                    <a href="{{ route('profile.edit') }}" class="block py-2 text-sm font-medium text-gray-700 hover:text-purple-600">
                        Profile
                    </a>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
            ...
            @else
                <a href="{{ route('login') }}" class="block py-2 text-sm font-medium text-gray-700 hover:text-purple-600">
                    Contact
                </a>
            @endauth
        </div>
